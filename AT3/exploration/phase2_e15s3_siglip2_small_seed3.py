...
# %% [markdown]
# # E15-s3 — Third seed of E15 (seed=456)
#
# E15-s2 (seed=123) beat E15 (seed=42) by +0.008 BLEU-4 / +0.023 CIDEr.
# That seed sensitivity is large enough that a third seed is informative
# both as a tiebreaker (is E15-s2 the lucky one or is E15 the unlucky
# one?) and as an additional member for a multi-seed self-ensemble.
...
cfg = ExperimentConfig(
    run_name="phase2_e15s3_siglip2_small_seed3",
...
metrics_e15s3 = run_experiment(cfg)
metrics_e15s3
